var size = 0;
var placement = 'point';
function categories_AR_Sungai_2(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Aman':
...
var style_AR_Sungai_2 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_AR_Sungai_2(feature, value, size, resolution, labelText,
